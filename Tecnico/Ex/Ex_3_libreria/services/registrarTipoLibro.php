<?php
  ...
  if(isset($_POST['pnIdLibro'])          &&
     isset($_POST['psNombreVersion'])        &&
     isset($_POST['pnValorVersion'])          ){
      /*Se setean los valores obtenidos en variables */
    $id_libro   = $_POST['pnIdLibro'];
    $nombre     = $_POST['psNombreVersion'];
    $valor      = $_POST['pnValorVersion'];
      /*Se declara la secuencia de SQL con el llamado al procedimiento almacenado con sus parametros */
    $sentencia_sql = "CALL insert_version_libro" ."('$id_libro','$nombre','$valor')";
