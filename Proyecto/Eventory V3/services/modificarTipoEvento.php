<?php
  ...
  if(isset($_POST['idElemento'])){
    ...
    $id                     = $_POST['idElemento'];
    $sImagePath             = $_POST['psImagePath'];
    $sNombreEvento          = $_POST['psNombreEvento'];
    $sDescripcionEvento     = $_POST['psDescripcionEvento'];
    $nDescuento             = $_POST['pnDescuento'];
    $id_tienda              = $_SESSION["id_tienda"];
    $estado                 = $_POST['estado'];
      /*Se declara la secuencia de SQL con el llamado al procedimiento almacenado con sus parametros */
    $sentencia_sql = "CALL update_tipo_evento" ."('$id','$sImagePath','$sNombreEvento','$sDescripcionEvento','$nDescuento','$id_tienda','$estado')";
