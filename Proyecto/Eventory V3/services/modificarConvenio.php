<?php
  ...
  if(isset($_POST['idElemento'])){
    ...
    $id                     = $_POST['idElemento'];
    $sCedulaJuridica        = $_POST['sCedulaJuridica'];
    $sNombre                = $_POST['sNombre'];
    $sDescripcionConvenio   = $_POST['sDescripcionConvenio'];
    $nDescuento             = $_POST['nDescuento'];
    $id_tienda              = $_SESSION["id_tienda"];
    $estado                 = $_POST['estado'];
      /*Se declara la secuencia de SQL con el llamado al procedimiento almacenado con sus parametros */
    $sentencia_sql = "CALL update_convenio" ."('$id','$sCedulaJuridica','$sNombre','$sDescripcionConvenio','$nDescuento','$id_tienda','$estado')";
