<?php
  ...
  if(isset($_POST['idElemento'])               &&
    ...
    $sentencia_sql = "CALL update_usuario" ."('$id','$cedula','$image_path','$nombre','$nombre2','$apellido','$apellido2','$pais','$fecha','$genero','$correo','$telefono','$telefono2','$contrasena','$tipo','$estado','$id_tienda','$juridico')";
