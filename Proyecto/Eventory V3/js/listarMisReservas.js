                ...
                for (var i = 0; i < length; i++) {
                    ...
                    var peticion2 = $.ajax({
                                ...
                                elLink.value = data[0]['id_lista'];
                                 ...
                                 } else if (data[0]['estado_reserva']==2) {
  ...
  var peticion = $.ajax({
      ...
      success: function(response){
          if (Number(response[0]['tipo']) != 4){
            window.location = "buscarListasAdmin.html?idLista=" + idEvento;
          }else {
            window.location = "buscarListas.html?idLista=" + idEvento;
          }
      },
      error: function(request, error) {
          alert(error);
