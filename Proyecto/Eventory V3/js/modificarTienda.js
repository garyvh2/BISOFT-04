...
function CargarDatos() {
    ...
    var peticion = $.ajax({
        ...
        success: function(response) {
            ...
            document.querySelector("#txtCedulaJuridica").value = response[0]['identificacion'];
...
function validarDatosTienda(vThis) {
    ...
    modificarDatosTienda(nCedula, sImagePath, sNombre, nTelefono, sCorreo, sProvincia, sCanton, sDistrito, nImpuestoVenta, sTipo, nLatitud, nLongitud, nidAdmin);

    return false;
}

function modificarDatosTienda(pnCedula, sImagePath, psNombre, pnTelefono, psCorreo, psProvincia, psCanton, psDistrito, pnImpuestoVenta, psTipo, pnLatitud, pnLongitud, pidAdmin) {
    var estado = 1;
    var peticion = $.ajax({
        url: "services/modificarTienda.php",
        type: "post",
        data: {
            'nCedula': pnCedula,
